...
public class ConsolaOlimpicos
{
	...
	/**
	 * MODIFICACION 1; CONSULTA PAIS DEL ATLETA
	 * Este método le pide al usuario el nombre del atleta 
	 * , lo pasa a CalculadoraEstadisticas para que pueda consultar el pa;is al 
	 * que pertenece
	 */
	
	private void ejecutarPaisAtleta() 
	{
			System.out.println("Busque el nombre del atleta para conocer el pais que representa");
			
			String nombre = input("Por favor ingrese el nombre del atleta");
			
			String paisatleta = calculadora.paisdelatleta(nombre);
			System.out.println("El pais que representa el atleta "+ nombre + ' '+"es " + paisatleta + '.');
		
	}
	
	/**
	 * FIN MODIFICACION 1 CONSULTA A MODULO CALCULADORA
	 */
